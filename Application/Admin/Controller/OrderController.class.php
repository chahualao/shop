...
class OrderController extends BaseController {
    ...
    public function ajaxindex(){
        ...
        //会员信息
        $user_mobile_or_nickname = I('user_mobile_or_nickname',false);
        if ($user_mobile_or_nickname) {
            if (is_numeric($user_mobile_or_nickname)) {
                $condition['u.mobile'] = $user_mobile_or_nickname;
            }else{
                $condition['u.nickname'] = $user_mobile_or_nickname;
            }
         } 
        //获取订单列表
