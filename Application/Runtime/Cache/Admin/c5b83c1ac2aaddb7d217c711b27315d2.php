                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>商品标签(风格)</td>
                                    <td>
                                        <select name="goods_tags" id="goods_tags" class="form-control" style="width:250px;">
                                            <option value="0">请选择商品标签</option>
                                            <?php if(is_array($goods_tags)): foreach($goods_tags as $k=>$v): ?><option value="<?php echo ($v); ?>"  <?php if($v == $goodsInfo['goods_tags'] ): ?>selected="selected"<?php endif; ?>>
                                                <?php echo ($v); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-2">
                                                <span id="err_goods" style="color:#F00; display:none;">请添加组合优惠商品</span>
                                            </div>                                            
                                        </div>                                    
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2"> 
                                       <div class="form-group">
                                          <table class="table table-bordered">
                                            ...
                                            <tbody id="goods_list">
                                            <?php if(is_array($zuhe_goods)): foreach($zuhe_goods as $key=>$vo): ?><tr>
...
-->                                
                                ...
                                <tr>
                                    <td>上传商品图片:</td>
                                    <td>
                                        <input type="button" value="上传图片"  onclick="GetUploadify(1,'','goods','call_back_one');"/>
                                ...
                                <tr>                                    
                                    ...
                                    <?php if(is_array($goodsImages)): foreach($goodsImages as $k=>$vo): ?><div style="width:100px; text-align:center; margin: 5px; display:inline-block;" class="goods_xc">
                                        ...
                                        <div class="goods_xc" style="width:100px; text-align:center; margin: 5px; display:inline-block;">
                                            ...
                                            <a href="javascript:void(0);" onclick="GetUploadify(10,'','goods','call_back_more');"><img src="/Public/images/add-button.jpg" width="100" height="100" /></a>
                                            <br/>
...
<script>
     ...
     */
    // 上传商品图片成功回调函数
    function call_back_one(fileurl_tmp){
        $("#original_img").val(fileurl_tmp);
    	$("#original_img2").attr('href', fileurl_tmp);
    }
 
    // 上传商品相册回调函数
    function call_back_more(paths){
...
function selectGoods(){
  var goods_id = []; 
  //过滤选择重复商品
  $('#goods_list input[name*="goods_id"]').each(function(i,o){
    goods_id.push($(o).val());
  });
    var url = '/index.php?m=Admin&c=Promotion&a=search_goods&goods_id='+goods_id+'&tpl=zuheyouhui_tpl'+'&t='+Math.random();
