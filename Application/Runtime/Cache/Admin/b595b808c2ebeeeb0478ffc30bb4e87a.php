...
<body class="sidebar-mini skin-purple" style="overflow-y:hidden;">
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/rehoming_logo.png" height="30"></span>
      </a>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2016-2017 <a href="http://rehoming.cn">上海瑞和家世界网络科技有限公司</a>.</strong>保留所有权利。
	</footer>
...
.orderfoods{ width:200px; border:1px solid #dedede; position:absolute; bottom:50px; z-index:999; right:10px; background-color:#605ca8;opacity:0.8;-webkit-opacity:0.8;filter:alpha(opacity=80);-moz-opacity:0.8;  }
