       		...
       		<div class="col-xs-12">
	           	...
	           	<div class="box-header">
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('Order/order_log');?>" id="search-form2" class="navbar-form form-inline" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="timegap" value="<?php echo ($timegap); ?>" placeholder="操作时间"  id="add_time" class="input-sm">
					                 </div>
                                </div>
                                <div class="form-group">
                                    <select name="admin_id" class="input-sm">
                                  	    <option value="0">选择管理员</option>
            						    <?php if(is_array($admin)): foreach($admin as $key=>$vv): ?><option value="<?php echo ($key); ?>"><?php echo ($vv); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td><?php echo ($vo["status_desc"]); ?></td>
		                      <td><?php echo ($admin[$vo[action_user]]); ?></td>
		                     <td><?php echo ($vo["action_note"]); ?></td>
		                     <td><?php echo (date('Y-m-d H:i',$vo["log_time"])); ?></td>
		                     <td><?php echo ($vo["status_desc"]); ?></td>
		                     <td>
		                     <a href="<?php echo U('Order/detail',array('order_id'=>$vo['order_id']));?>" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="查看详情"><i class="fa fa-eye"></i></a>
