				        ...
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('Promotion/prom_goods_list');?>" method="post">
				            ...
				            <div class="form-group pull-right">
					            <a href="<?php echo U('Promotion/prom_goods_info');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加活动</a>
				            </div>		          
				          </form>		
				      	</div>
	    			</nav>                
	             ...
	             <div class="box-body">	             
	            	...
	            	<div class="col-sm-12">
		              <table id="list-table" class="table table-bordered table-striped dataTable">
		                 <thead>
		                   <tr role="row">
		                   	   <th class="sorting" tabindex="0">活动排序</th>
						...
						<tbody>
						  <?php if(is_array($prom_list)): foreach($prom_list as $k=>$vo): ?><tr role="row" align="center">
							 ...
							 <td>
							  <a class="btn btn-primary <?php if($vo["star"] == 1): ?>start-active<?php endif; ?>" href="<?php echo U('Promotion/prom_goods_star',array('id'=>$vo['id']));?>" data-url=" " data-id="<?php echo ($vo["id"]); ?>" title="推荐到首页" ><i class="fa fa-star"></i></a>
		                      ...
		                      <a class="btn btn-danger" href="<?php echo U('/Mobile/Promotion/index',array('pid'=>$vo['id']));?>" target="_blank">促销链接</a>
		                      <a class="btn btn-primary" href="<?php echo U('Promotion/prom_goods_info',array('id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
