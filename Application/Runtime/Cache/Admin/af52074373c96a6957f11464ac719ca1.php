				        ...
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('/Admin/linkList');?>" method="post">
				            ...
				            <div class="form-group pull-right">
					            <a href="<?php echo U('Article/link');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>新增链接</a>
				            </div>		          
				          </form>		
				      	</div>
	    			</nav>               
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      <a class="btn btn-primary" href="<?php echo U('Article/link',array('act'=>'edit','link_id'=>$vo['link_id']));?>"><i class="fa fa-pencil"></i></a>
		                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Article/linkHandle');?>" data-id="<?php echo ($vo["link_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
							</td>
