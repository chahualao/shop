  						...
  						<form action="" method="post">
		  					<div class="col-xs-2">
				                  ...
				                  <select name="cat_id" id="cat_id" class="form-control">
				                    ...
				                    <?php if(is_array($categoryList)): foreach($categoryList as $k=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($cat_id == $v[id]): ?>selected<?php endif; ?>> <?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
				                  </select>
			                  </div>
		  					</div>	
		  					<div class="col-xs-2">
				                  ...
				                  <select name="brand_id" id="brand_id" class="form-control">
				                    <option value="0">所有品牌</option>
				                        <?php if(is_array($brandList)): foreach($brandList as $k=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($brand_id == $v[id]): ?>selected<?php endif; ?>><?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
				                  </select>
				                </div>   	
                			</div>				
				  			<div class="col-xs-4">         
