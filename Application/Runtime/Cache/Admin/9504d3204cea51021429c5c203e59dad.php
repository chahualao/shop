              ...
              <form action="<?php echo U('Coupon/send_coupon');?>" id="search-form" class="navbar-form form-inline" method="post">
                <div class="form-group">
                  <select name="level_id" id="level_id" class="form-control">
                    ...
                    <?php if(is_array($level)): foreach($level as $key=>$vo): ?><option value="<?php echo ($vo['level_id']); ?>" <?php if($vo[level_id] == $level_id): ?>selected<?php endif; ?>> <?php echo ($vo['level_name']); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
