        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> 编辑抢购活动</h3>
                </div>
                    ...
                    <div class="tab-content col-md-10">                 	  
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                	<td>参加抢购数量:</td>
                                	<td><input type="text" name="goods_num" id="goods_num" class="form-control" value="<?php echo ($info["goods_num"]); ?>" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')"/></td>
