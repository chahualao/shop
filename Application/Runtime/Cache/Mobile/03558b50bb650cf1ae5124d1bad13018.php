	...
	<body>
		<div class="tab_nav">
			<div class="header">
				...
				<div class="h-mid"><?php echo ($protomain['name']); echo ($protomain['sub_name']); ?></div>
				<div class="h-right">
					<aside class="top_bar">
						<div id="show_more">
							<a href="javascript:;"></a>
		...
		<!--banner-->
		<div class="banner">	
			<img src="<?php echo ($protomain["extra_img_url"]); ?>" width="100%" id="banner-618"/>			
		</div>
		...
		<?php if(is_array($goods)): foreach($goods as $k=>$vo): ?><li>
