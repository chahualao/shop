...
class MobileBaseController extends Controller {
    ...
    public function _initialize() {
        ...
        //$this->assign('debuginfo2',$debuginfo2);
        $this->public_assign();
    }
    ...
    public function public_assign()
    {
       ...
       $tpshop_config = array();
       $tp_config = M('config')->cache(true,60)->select();       
       ...
       $brand_list = M('brand')->cache(true,10)->field('id,name,parent_cat_id,logo,is_hot')->where("parent_cat_id>0")->select();              
    ...
    public function GetOpenid()
    {
        ...
        if (!isset($_GET['code'])){
            ...
            //$this->assign('confirm_url', $url);
            //$this->display('Public/wx_confirm');
...
//        $urlObj["scope"] = "snsapi_base";
        ...
        //进行了微信授权转发
        return "http://api.rehoming.cn/weixin/index/getWeiXinCode.html?".$bizString;
    }
